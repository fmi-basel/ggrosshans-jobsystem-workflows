# Marit 15-09-2020. This is the file you run. It gets the parameters from the jobsystem,
# imports them insert them in the WormQuantification task
'''Provides quantification workflows for image-based assay.

'''
import luigi
from ggjw.workflows.base import JobSystemWorkflow  # Jobsystemworkflow is empty? -> Needed for jobsystem frontend to identify runnable jobs
from ggjw.tasks.quantification.python_quantification import WormQuantificationTask


class WormQuantificationWorkflowExperimental(luigi.WrapperTask,
                                             JobSystemWorkflow):
    ...
    '''folder containing the segmentation corresponding to the images in image_folder.'''
